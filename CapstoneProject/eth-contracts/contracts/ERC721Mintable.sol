...
contract Ownable {
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        require(newOwner != _owner, "already a owner");
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(_tokenOwner[tokenId] != to, "Caller is already an owner of this token");

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == _owner || isApprovedForAll(_owner, msg.sender), "Not approved");
        
        // TODO add 'to' address to token approvals
        _tokenApprovals[tokenId] = to;

        // TODO emit Approval Event
        emit Approval(to, msg.sender, tokenId);(tokenId);
    }
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(_exists(tokenId) == false, "Given token Id already exists");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(from == _tokenOwner[tokenId], "from address is not the owner of this token");

        // TODO: require token is being transfered to valid address
        require(to.isContract() == false, "Invalid address");
...
contract CustomizedTokenERC721 is ERC721Metadata("CustomizedTokenERC721", "MAN", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {
